...
class MobileNavBar extends Component<MobileNavBarProps, MobileNavBarState> {
  ...
  render() {
    ...
    return (
      <nav
        style={{ backgroundColor: 'rgba(30, 30, 30, 1)', padding: '1rem', zIndex: 2, position: 'relative' }}
      ...
      >
        ...
        <div className="relative menu-container" ref={this.menuRef}>
          <button
          className="text-white px-4 py-2 rounded-full focus:outline-none focus:ring-0 focus:border-black-800 bg-black-300 hover:bg-black"
          ...
          <ul className="py-2">
          <li className="hover:bg-black-600 py-2 px-6 border-b border-white">
          <a href="/ML/Physics" className="text-white block w-full">
              ...
              <li className="hover:bg-black-600 py-2 px-6">
                <a href="/" className="text-white block w-full">
                  Animation
                </a>
              </li>

...
class MobileNavBar extends Component<MobileNavBarProps, MobileNavBarState> {
  ...
  render() {
    ...
    return (
      <nav
        style={{ backgroundColor: 'rgba(74, 112, 194, 0.75)', padding: '1rem', zIndex: 2, position: 'relative' }}
      ...
      >
        ...
        <div className="relative menu-container" ref={this.menuRef}>
          <button
            className="text-white px-4 py-2 rounded-full focus:outline-none focus:ring focus:border-blue-300 bg-blue-500 hover:bg-blue-600"
          ...
          {isListVisible && (
            <div className="absolute right-0 top-full bg-blue-500 rounded-md shadow-lg border border-white">
              <ul className="py-2">
                <li className="hover:bg-blue-600 py-2 px-6 border-b border-white">
                  <a href="/ML/Physics" className="text-white block w-full">
                    Theoretical Physics
                  </a>
                </li>
                <li className="hover:bg-blue-600 py-2 px-6 border-b border-white">
                ...
                <li className="hover:bg-blue-600 py-2 px-6">
